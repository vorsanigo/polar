...
<p align="center">
    <img src="img/sys_machamp.jpg" width="800" alt="System overview image">
    <a>Fig. 1</a>: <i> High-level overview of our multi-task learning framework for polarization detection and classification, with an example from the \texttt{train} set and associated output labels for the three \textsc{polar} subtasks.</i>
</p>
